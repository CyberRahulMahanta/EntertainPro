<%@ Page Title="" Language="C#" MasterPageFile="~/AdminSite.Master" AutoEventWireup="true" CodeFile="AdminIndex.aspx.cs" Inherits="EntertainPro.AdminIndex" %>
                ...
                <div class="space-y-4">
                    <div class="flex items-center justify-between p-3 bg-slate-50 rounded-lg">
                        <div class="flex items-center space-x-3">
                            <div
                                class="w-10 h-10 bg-red-600 rounded-lg flex items-center justify-center text-white font-bold">
                                1
                            </div>
                            <div>
                                <p class="font-medium">Starlight Rebellion</p>
                                <p class="text-sm text-slate-600">Sci-Fi • 2h 15m</p>
                            </div>
                        </div>
                        <div class="text-right">
                            <p class="font-semibold">1,247</p>
                    ...
                    <div class="flex items-center justify-between p-3 bg-slate-50 rounded-lg">
                        <div class="flex items-center space-x-3">
                            <div
                                class="w-10 h-10 bg-slate-400 rounded-lg flex items-center justify-center text-white font-bold">
                                2
                            </div>
                            <div>
                                <p class="font-medium">Ocean's Mystery</p>
                                <p class="text-sm text-slate-600">Thriller • 1h 58m</p>
                            </div>
                        </div>
                        <div class="text-right">
                    ...
                    <div class="flex items-center justify-between p-3 bg-slate-50 rounded-lg">
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                <p class="font-medium">Comedy Central</p>
                                <p class="text-sm text-slate-600">Comedy • 1h 42m</p>
                            </div>
                        </div>
                        <div class="text-right">
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-slate-200">
                        <thead class="bg-slate-50">
                            <tr>
                                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-slate-500 uppercase tracking-wider">Booking ID
                                </th>
                                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-slate-500 uppercase tracking-wider">Movie / Time
                                </th>
                                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-slate-500 uppercase tracking-wider">Seats
                                </th>
                                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-slate-500 uppercase tracking-wider">Amount
                                </th>
                                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-slate-500 uppercase tracking-wider">Status
                                </th>
                            </tr>
                        </thead>
                        <tbody class="divide-y divide-slate-200">
                            <tr class="hover:bg-slate-50 transition-colors">
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-slate-900">#BK00124</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-slate-800">
                                    <span class="font-medium">Starlight Rebellion</span>
                                    <p class="text-xs text-slate-500">Today, 7:00 PM</p>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-slate-600">3</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-semibold text-green-600">$37.50</td>
                            ...
                            <tr class="hover:bg-slate-50 transition-colors">
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-slate-900">#BK00123</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-slate-800">
                                    <span class="font-medium">Ocean's Mystery</span>
                                    <p class="text-xs text-slate-500">Today, 2:30 PM</p>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-slate-600">2</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-semibold text-green-600">$25.00</td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800">Completed
                                    </span>
                                </td>
                            ...
                            <tr class="hover:bg-slate-50 transition-colors">
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-slate-900">#BK00122</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-slate-800">
                                    <span class="font-medium">The Silent Forest</span>
                                    <p class="text-xs text-slate-500">Yesterday, 9:00 PM</p>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-slate-600">5</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-semibold text-yellow-600">$62.50</td>
                                <td class="px-6 py-4 whitespace-nowrap">
